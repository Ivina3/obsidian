...
var TodoistProjectSync = class extends import_obsidian.Plugin {
  ...
  setRefreshInterval() {
    ...
    if (this.settings.TodoistSyncFrequency > 0)
      this.refreshIntervalID = this.registerInterval(window.setInterval(
        async () => {
  ...
  async updateTodoistProjectFiles() {
    ...
    this.todoistApi = new import_todoist_api_typescript.TodoistApi(this.settings.TodoistToken);
    ...
    try {
      ...
      projects.forEach(async (element) => {
        ...
        const filename = (0, import_obsidian.normalizePath)(this.settings.TodoistProjectFolder + filepath + "/" + element.name + ".md");
        if (!this.app.vault.getAbstractFileByPath(filename)) {
          if (!filesById[element.id]) {
            ...
            if (!await this.app.vault.adapter.exists("/" + filename) && await this.app.vault.adapter.exists("/" + filesById[element.id].path)) {
              ...
              if (this.app.vault.getAbstractFileByPath((0, import_obsidian.normalizePath)(oldPath)) instanceof import_obsidian.TFolder) {
                let folderToDelete = this.app.vault.getAbstractFileByPath((0, import_obsidian.normalizePath)(oldPath));
                let keepDeleting = true;
                if (folderToDelete.children.length == 0) {
                  while (keepDeleting) {
                    const nextfolderToDelete = folderToDelete == null ? void 0 : folderToDelete.parent;
      ...
      files.forEach((file) => {
        ...
        const Metadata = this.app.metadataCache.getFileCache(file);
        if ((_a = Metadata == null ? void 0 : Metadata.frontmatter) == null ? void 0 : _a.TodoistId) {
          const todoistId = (_b = Metadata == null ? void 0 : Metadata.frontmatter) == null ? void 0 : _b.TodoistId;
      ...
      filesToRemove.forEach(async (file) => {
        ...
        const Metadata = this.app.metadataCache.getFileCache(file);
        const projectNameFromMeta = (_a = Metadata == null ? void 0 : Metadata.frontmatter) == null ? void 0 : _a.projectName;
        const todooistId = (_b = Metadata == null ? void 0 : Metadata.frontmatter) == null ? void 0 : _b.TodoistId;
  ...
  getPath(projects, currentProjectId) {
    ...
    if (currentProjectId) {
      ...
      if (currentProject == null ? void 0 : currentProject.parentId) {
        const parentProj = projects.find((proj) => proj.id === (currentProject == null ? void 0 : currentProject.parentId));
        if (parentProj)
